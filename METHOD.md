...
Золотой стандарт — как всегда здесь, один: подборки в Пабмеде, а если значится в неисключенных в Пабмеде, то СТМЗ. Так и продолжу работать. Если выясняется, что несколько шагов проставлено для одной записи (а такое попалось), то автоматически выбираю верхний.
