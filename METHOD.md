...
Так, сразу все выделить и исключить одним разом — нельзя, поэтому приходится поодиночке, но в веб-версии Рэйана это относительно быстро все должно получиться.

В `Conflicting decisions` ставлю: `Target wins`. Это чтобы ненароком не поперезаписывать исключения.

В итоге буду контролировать что: чтобы по завершении копирований числа записей по категориям исключения в целевом обзоре совпадали с таковыми по подборкам в Пабмеде.
