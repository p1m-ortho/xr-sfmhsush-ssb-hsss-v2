...
## Актуальность репозитория

Обзор изначально задумывали как самостоятельный, но затем его свернули в пользу [более прикладного обзора под дисс. по типу A](https://github.com/p1m-ortho/xt-ao-type-a) (см. на эту тему детально в [СТМЗ](https://github.com/p1m-ortho/xr-sfmhsush-ssb-hsss-v2/blob/b4a5a48f7b70235ab93e11808f9d222074d9b229/stmz3_-_a_record_t1_-_ws_c25_90.csv)).
...
Работаем по [протоколу](#протокол-обзора), поиски проведены, см. [историю коммитов этого репозитория](https://github.com/p1m-ortho/xr-sfmhsush-ssb-hsss-v2/commits/master), а также [историю коммитов xt-ao-type-a до e5e2bf3 включительно](https://github.com/p1m-ortho/xt-ao-type-a/commits/e5e2bf3a3d31657b6ae3eb14d24c26a5dd5d5aa6). Общая выборка обзора составила 1135 записей.
...
Полную выдачу 1135 на момент коммита с текущими решениями всех участников прикрепляю (`articles_1135_EBD_PVZ_SAS_preconsensus_unmasked.bib`). Текущий экспорт 1148 также прикрепляю для совместимости (`articles_1148_EBD_PVZ_SAS_preconsensus_unmasked.bib`).
...
> ПВЖ:
>
> Кстати, если кто из читателей не в курсе, узнать, «на момент коммита» — когда это было,— можно с легкостью в [режиме просмотра «Blame»](https://help.github.com/en/articles/tracking-changes-in-a-file).
...
### Скрининг библиографических записей (скрининг-1)
...
1. 7866ceb5feef10b0_24266_40538_2019-02-25_15-30-27.zip
1. 614bdfaba21e2567_24266_40538_2019-02-25_15-30-14.zip
1. e4a1a13247222e54_24266_40538_2019-02-25_15-29-50.zip
1. 2f01ed42cf02036f_24266_40538_2019-02-25_15-30-03.zip
1. 86a1c25cce0ed816_24266_40538_2019-02-25_15-27-50.zip
1. 398d0ba1fa6e7e1e_24266_40538_2019-02-25_15-28-57.zip
1. b51d4a00865a02b8_24266_40538_2019-02-25_15-28-44.zip
1. 77e2117181ebe933_24266_40538_2019-02-25_15-28-32.zip
1. b059703cd78c1034_24266_40538_2019-02-25_15-28-15.zip
1. 7f8c3c34f886cefb_24266_40538_2019-02-25_15-27-26.zip
1. f1f59a859149fdd3_24266_40538_2019-02-25_15-27-36.zip
1. 617e21ddebd3fe2f_24266_40538_2019-02-25_15-26-21.zip
1. 2e71f3eef5b351ce_24266_40538_2019-02-25_15-27-05.zip
1. b6f1b100afaff6a9_24266_40538_2019-02-25_15-26-43.zip
...
До того, как я не начал скринить эти последние оставшиеся 111, все 1148 на всякий случай также выгрузил вместе со всеми решениями: в BibTeX (`832f3a60283e75ed_24266_40538_2019-02-24_21-01-59.zip`) и в CSV (`fcdab986c480a9bb_24266_40538_2019-02-24_21-02-13.zip`). Не публикую для предупреждения срыва маскирования (с ЭБД согласие еще не рассчитали, консенсус не провели, САС еще не закончила скрининг). 111 там значатся как неотскриненные, потому что я только что убрал их из включенных и снял с них лейбл `nostmz` (чтобы удобнее было скринить).
...
См. [историю коммитов репозитория](https://github.com/p1m-ortho/xr-sfmhsush-ssb-hsss-v2/commits/master).

### 1 Актуальность и задачи

См. на тему актуальности в [экспорте из СТМЗ](https://github.com/p1m-ortho/xr-sfmhsush-ssb-hsss-v2/blob/b4a5a48f7b70235ab93e11808f9d222074d9b229/stmz3_-_a_record_t1_-_ws_c25_90.csv).

Оригинальная цель обзора (согласно [оригинальному протоколу](https://github.com/p1m-ortho/xr-sfmhsush-ssb-hsss-v2/blob/master/XR_AO_types_-_Appendices.md#приложение1-протокол-обзора-литературы-оригинальная-редакция-28052018)):
...
### 2 Планирование и регистрация

О ходе планирования см. [историю коммитов репозитория](https://github.com/p1m-ortho/xr-sfmhsush-ssb-hsss-v2/commits/master).

Дополнительную регистрацию где-либо помимо настоящего репозитория на GitHub не предпринимали, в том числе и на [OSF.io](https://osf.io), причины этого см. в 8fc623c2ef509f17cfeb3a90c809befdc76895a1, 1547917aef9853f869e5647b19c01998b6ac84b5.

### 3 Поиски

См. [README.md](https://github.com/p1m-ortho/xr-sfmhsush-ssb-hsss-v2/tree/8a0e0203684cb3e6fd4522d08bdfb254dfd467cb).

### 4 Скрининг библиографических записей (1-й этап скрининга)

Скрининг проводим в [Rayyan](https://rayyan.qcri.org).
...
### 5 Скрининг полных текстов (2-й этап скрининга)
...
### 6 Извлечение данных (картирование)
...
### 7 Качественный синтез данных и оценка их качества

Планируем, в разработке.

### 8 Количественный синтез данных

Не планируем.

### 9 Представление и публикация результатов
